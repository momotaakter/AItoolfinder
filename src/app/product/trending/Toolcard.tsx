...
const Toolcard: FC<ToolCardProps> = ({
  ...
  return (
    <div className="w-full max-w-full overflow-hidden">
      ...
      <div className="max-w-3xl bg-white rounded-2xl shadow-md p-5 flex flex-col sm:flex-row items-start gap-4 transition-all duration-200 hover:shadow-lg w-full">
        {/* Avatar */}
